...
git clone -b lineage-23.0 --depth 1 https://github.com/lightbulb-box/kernel_xiaomi_sm8635.git kernel/xiaomi/sm8635
...
# Dolby
git clone -b lineage-23.0 https://github.com/lightbulb-box/android_packages_apps_XiaomiDolby.git packages/apps/XiaomiDolby
